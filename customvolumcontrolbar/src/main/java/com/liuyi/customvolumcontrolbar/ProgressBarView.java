...
public class ProgressBarView extends View {
    ...
    public void start() {
        /*矩形变化的动画*/
        final ValueAnimator rectangleChangeAnimator = ValueAnimator.ofFloat(0, mBackgroundRectWidthChangeRange);
        ...
        /*箭头横向位移的动画*/
        final ValueAnimator arrowHorizontalDisplacementAnimator = ValueAnimator.ofFloat(0, mBackgroundRectWidth / 2 + mBackgroundRectWidthChangeRange);
        ...
        /*箭头往上跳动的动画*/
        final ValueAnimator arrowUpDisplacementAnimator = ValueAnimator.ofFloat(0, mArrowSideLength + 12);
