...
public class RxJavaTest {
    ...
    /*public void test() {
        ...
        Function<Observable<Throwable>, ObservableSource<?>> handler = new Function<Observable<Throwable>, ObservableSource<?>>() {
            @Override
        ...
        observable.retryWhen(handler).subscribeOn(Schedulers.io())               // 切换到IO线程进行网络请求
